...
#define SELFCAP_SENSOR_MAX  (31)        /* Maximum number of enable sensor number + 1 */

/* Chip ID */
#define DF_CHIP_ID    ((DF_CCMD_VER << 8) | SELFCAP_SENSOR_MAX)

/* Date of source file creation */
#define CREATE_SOURCE_DATE0	(0x1712)    /* YYMM */
#define CREATE_SOURCE_DATE1	(0x2717)	/* DDHH */
#define CREATE_SOURCE_DATE2	(0x0231)    /* MMSS */
#define CREATE_SOURCE_DATE3	(0x0000)    /* 0000 */

/* Information for suppoted function */
#define ABILITY_CORRECT_SENSOR_SELF   (1)   /* Sensor correction support status at Self capacitance */
#define ABILITY_CORRECT_SENSOR_MUTUAL (1)   /* Sensor correction support status at Mutlal capacitance */

#define ABILITY_INFORMATION           ((ABILITY_CORRECT_SENSOR_SELF << 0) + \
                                       (ABILITY_CORRECT_SENSOR_MUTUAL << 1) \
                                      )
...
/*====================================================================================================================*/
#define MUTUAL0_KEY00_USE        (0)
#define MUTUAL0_KEY01_USE        (0)
#define MUTUAL0_KEY02_USE        (0)
#define MUTUAL0_KEY03_USE        (0)
#define MUTUAL0_KEY04_USE        (0)
#define MUTUAL0_KEY05_USE        (0)
#define MUTUAL0_KEY06_USE        (0)
#define MUTUAL0_KEY07_USE        (0)
#define MUTUAL0_KEY08_USE        (0)
#define MUTUAL0_KEY09_USE        (0)
#define MUTUAL0_KEY10_USE        (0)
#define MUTUAL0_KEY11_USE        (0)
#define MUTUAL0_KEY12_USE        (0)
#define MUTUAL0_KEY13_USE        (0)
#define MUTUAL0_KEY14_USE        (0)
#define MUTUAL0_KEY15_USE        (0)
#define MUTUAL0_KEY16_USE        (0)
#define MUTUAL0_KEY17_USE        (0)
#define MUTUAL0_KEY18_USE        (0)
#define MUTUAL0_KEY19_USE        (0)
...
/* ON/OFF threshold set up data */
#define MUTUAL0_KEY00_THR          (1000)
#define MUTUAL0_KEY01_THR          (1001)
#define MUTUAL0_KEY02_THR          (1002)
#define MUTUAL0_KEY03_THR          (1003)
#define MUTUAL0_KEY04_THR          (1004)
#define MUTUAL0_KEY05_THR          (1005)
#define MUTUAL0_KEY06_THR          (1006)
#define MUTUAL0_KEY07_THR          (1007)
#define MUTUAL0_KEY08_THR          (1008)
#define MUTUAL0_KEY09_THR          (1009)
#define MUTUAL0_KEY10_THR          (1010)
#define MUTUAL0_KEY11_THR          (1011)
...
#define SLIDER0_THRESHOLD                (1000)              /* Slider ID 0 position calculation threshold            */
#define SLIDER0_RESOLUTION               (1)                /* Slider ID 0 resolution (1=100,2=50,4=25,5=20,10=10)   */
#define SLIDER0_THR_OFFSET_VAL           (0)                /* Slider ID 0 threshold offset value                    */
...
#define SLIDER1_THR_OFFSET_VAL           (0)                /* Slider ID 1 threshold offset value                    */
...
#define SLIDER2_THR_OFFSET_VAL           (0)                /* Slider ID 2 threshold offset value                    */
...
#define SLIDER3_THR_OFFSET_VAL           (0)                /* Slider ID 3 threshold offset value                    */
...
#define SLIDER4_THR_OFFSET_VAL           (0)                /* Slider ID 4 threshold offset value                    */
...
#define SLIDER5_THR_OFFSET_VAL           (0)                /* Slider ID 5 threshold offset value                    */
...
#define SLIDER6_THR_OFFSET_VAL           (0)                /* Slider ID 6 threshold offset value                    */
...
#define SLIDER7_THR_OFFSET_VAL           (0)                /* Slider ID 7 threshold offset value                    */
...
#define WHEEL0_THRESHOLD                 (800)              /* Wheel ID 0 position calculation threshold             */
#define WHEEL0_RESOLUTION                (1)                /* Wheel ID 0 resolution (1=90,2=45,3=30,5=18,9=10)      */
#define WHEEL0_THR_OFFSET_VAL            (0)                /* Wheel ID 0 threshold offset value                     */
...
#define WHEEL1_THR_OFFSET_VAL            (0)                /* Wheel ID 1 threshold offset value                     */
...
#define WHEEL2_THR_OFFSET_VAL            (0)                /* Wheel ID 2 threshold offset value                     */
...
#define WHEEL3_THR_OFFSET_VAL            (0)                /* Wheel ID 3 threshold offset value                     */
...
#define WHEEL4_THR_OFFSET_VAL            (0)                /* Wheel ID 4 threshold offset value                     */
...
#define WHEEL5_THR_OFFSET_VAL            (0)                /* Wheel ID 5 threshold offset value                     */
...
#define WHEEL6_THR_OFFSET_VAL            (0)                /* Wheel ID 6 threshold offset value                     */
...
#define WHEEL7_THR_OFFSET_VAL            (0)                /* Wheel ID 7 threshold offset value                     */
...
#if (SLIDER_NUMBER >= 1)
    uint16_t    slider[SLIDER_NUMBER];               /* Slider position result                                        */
#else
    uint16_t    slider[1];                           /* Slider position result(dummy)                                 */
#endif    // (SLIDER_NUMBER >= 1)
#if (WHEEL_NUMBER >= 1)
    uint16_t    wheel[WHEEL_NUMBER];                 /* Wheel position result                                         */
#else
    uint16_t    wheel[1];                            /* Wheel position result(dummy)                                  */
#endif    // (WHEEL_NUMBER >= 1)
...
* Global variables
***********************************************************************************************************************/
TOUCH_EXTERN touch_system_t          g_touch_system;
TOUCH_EXTERN touch_func_flag_t       g_touch_function[METHOD_NUM];
TOUCH_EXTERN touch_func_param_t      g_touch_paramter[METHOD_NUM];
TOUCH_EXTERN key_info_t              g_key_info[METHOD_NUM];
TOUCH_EXTERN touch_tuning_t          g_touch_tuning_info[METHOD_NUM];
TOUCH_EXTERN calib_info_t            g_calib_info[METHOD_NUM];
TOUCH_EXTERN key_user_param_t        g_key_user_parameter[METHOD_NUM];
TOUCH_EXTERN touch_group_param_t     g_touch_key_group[METHOD_NUM];
TOUCH_EXTERN touch_result_t          g_touch_all_result[METHOD_NUM];

TOUCH_EXTERN  volatile uint8_t       g_ctsu_soft_mode;                   /* CTSU operating mode flag                  */
TOUCH_EXTERN  volatile uint8_t       g_data_tim;                         /* Calibration data storage times            */

#if ( SELF_METHOD_NUM == 1 )

#if ( SELF_KEY_NUM == 0)
#else
/*****    Self measurement data storage buffer    *********************************************************************/
TOUCH_EXTERN uint16_t    g_self_ref[SELF_KEY_NUM];                       /* Reference                                 */
TOUCH_EXTERN uint16_t    g_self_thr[SELF_KEY_NUM];                       /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_self_user_thr[SELF_KEY_NUM];                  /* User threshold                            */
TOUCH_EXTERN uint16_t    g_self_hys[SELF_KEY_NUM];                       /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_self_delta[SELF_KEY_NUM];                     /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_self_touch_cnt[SELF_KEY_NUM];                 /* Touch count                               */
TOUCH_EXTERN uint16_t    g_self_non_touch_cnt[SELF_KEY_NUM];             /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_self_in_touch[SELF_MAX_GROUP];                /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_self_out_touch[SELF_MAX_GROUP];               /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_self_touch_result[SELF_MAX_GROUP];            /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_self_drift_permission[SELF_MAX_GROUP];        /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_self_drift_ref[SELF_KEY_NUM];                 /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_self_drift_cnt[SELF_KEY_NUM];                 /* Drift counter                             */
#if (16 > MAX_TS)
    TOUCH_EXTERN uint16_t    g_self_key_uesd_info[1];                    /* Used key infomation                       */
#elif (32 > MAX_TS)
    TOUCH_EXTERN uint16_t    g_self_key_uesd_info[2];                    /* Used key infomation                       */
#else
    TOUCH_EXTERN uint16_t    g_self_key_uesd_info[3];                    /* Used key infomation                       */
#endif
TOUCH_EXTERN uint16_t    g_self_calib[SELF_KEY_NUM][CALIB_TIME];         /* Self measurement                          */
#endif    // ( SELF_KEY_NUM == 0)

TOUCH_EXTERN uint8_t     g_self_sensor_index[MAX_TS];                    /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_self_counter_magni[SELF_ENABLE_NUM];          /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_self_tune_ctsuso[SELF_ENABLE_NUM];            /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile uint8_t    g_self_tune_result[SELF_ENABLE_NUM];   /* Offset tuning result data                 */
#endif    // ( SELF_METHOD_NUM == 1 )

#if ( MUTUAL_METHOD_NUM >= 1 )
/*****    Mutual 0 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual0_ref[MUTUAL0_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual0_thr[MUTUAL0_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual0_user_thr[MUTUAL0_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual0_hys[MUTUAL0_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual0_delta[MUTUAL0_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual0_touch_cnt[MUTUAL0_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual0_non_touch_cnt[MUTUAL0_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual0_in_touch[MUTUAL0_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual0_out_touch[MUTUAL0_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual0_touch_result[MUTUAL0_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual0_drift_permission[MUTUAL0_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual0_drift_ref[MUTUAL0_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual0_drift_cnt[MUTUAL0_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual0_key_uesd_info[MUTUAL0_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual0_sensor_index[MUTUAL0_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual0_counter_magni[MUTUAL0_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual0_tune_ctsuso[MUTUAL0_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual0_tune_result[MUTUAL0_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual0_calib[MUTUAL0_KEY_NUM][CALIB_TIME];   /* Mutual 0 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 1 )

#if ( MUTUAL_METHOD_NUM >= 2 )
/*****    Mutual 1 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual1_ref[MUTUAL1_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual1_thr[MUTUAL1_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual1_user_thr[MUTUAL1_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual1_hys[MUTUAL1_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual1_delta[MUTUAL1_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual1_touch_cnt[MUTUAL1_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual1_non_touch_cnt[MUTUAL1_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual1_in_touch[MUTUAL1_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual1_out_touch[MUTUAL1_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual1_touch_result[MUTUAL1_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual1_drift_permission[MUTUAL1_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual1_drift_ref[MUTUAL1_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual1_drift_cnt[MUTUAL1_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual1_key_uesd_info[MUTUAL1_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual1_sensor_index[MUTUAL1_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual1_counter_magni[MUTUAL1_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual1_tune_ctsuso[MUTUAL1_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual1_tune_result[MUTUAL1_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual1_calib[MUTUAL1_KEY_NUM][CALIB_TIME];   /* Mutual 1 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 2 )

#if ( MUTUAL_METHOD_NUM >= 3 )
/*****    Mutual 2 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual2_ref[MUTUAL2_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual2_thr[MUTUAL2_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual2_user_thr[MUTUAL2_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual2_hys[MUTUAL2_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual2_delta[MUTUAL2_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual2_touch_cnt[MUTUAL2_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual2_non_touch_cnt[MUTUAL2_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual2_in_touch[MUTUAL2_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual2_out_touch[MUTUAL2_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual2_touch_result[MUTUAL2_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual2_drift_permission[MUTUAL2_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual2_drift_ref[MUTUAL2_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual2_drift_cnt[MUTUAL2_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual2_key_uesd_info[MUTUAL2_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual2_sensor_index[MUTUAL2_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual2_counter_magni[MUTUAL2_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual2_tune_ctsuso[MUTUAL2_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual2_tune_result[MUTUAL2_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual2_calib[MUTUAL2_KEY_NUM][CALIB_TIME];   /* Mutual 2 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 3 )

#if ( MUTUAL_METHOD_NUM >= 4 )
/*****    Mutual 3 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual3_ref[MUTUAL3_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual3_thr[MUTUAL3_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual3_user_thr[MUTUAL3_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual3_hys[MUTUAL3_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual3_delta[MUTUAL3_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual3_touch_cnt[MUTUAL3_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual3_non_touch_cnt[MUTUAL3_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual3_in_touch[MUTUAL3_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual3_out_touch[MUTUAL3_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual3_touch_result[MUTUAL3_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual3_drift_permission[MUTUAL3_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual3_drift_ref[MUTUAL3_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual3_drift_cnt[MUTUAL3_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual3_key_uesd_info[MUTUAL3_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual3_sensor_index[MUTUAL3_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual3_counter_magni[MUTUAL3_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual3_tune_ctsuso[MUTUAL3_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual3_tune_result[MUTUAL3_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual3_calib[MUTUAL3_KEY_NUM][CALIB_TIME];   /* Mutual 3 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 4 )

#if ( MUTUAL_METHOD_NUM >= 5 )
/*****    Mutual 4 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual4_ref[MUTUAL4_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual4_thr[MUTUAL4_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual4_user_thr[MUTUAL4_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual4_hys[MUTUAL4_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual4_delta[MUTUAL4_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual4_touch_cnt[MUTUAL4_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual4_non_touch_cnt[MUTUAL4_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual4_in_touch[MUTUAL4_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual4_out_touch[MUTUAL4_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual4_touch_result[MUTUAL4_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual4_drift_permission[MUTUAL4_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual4_drift_ref[MUTUAL4_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual4_drift_cnt[MUTUAL4_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual4_key_uesd_info[MUTUAL4_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual4_sensor_index[MUTUAL4_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual4_counter_magni[MUTUAL4_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual4_tune_ctsuso[MUTUAL4_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual4_tune_result[MUTUAL4_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual4_calib[MUTUAL4_KEY_NUM][CALIB_TIME];   /* Mutual 4 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 5 )

#if ( MUTUAL_METHOD_NUM >= 6 )
/*****    Mutual 5 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual5_ref[MUTUAL5_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual5_thr[MUTUAL5_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual5_user_thr[MUTUAL5_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual5_hys[MUTUAL5_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual5_delta[MUTUAL5_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual5_touch_cnt[MUTUAL5_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual5_non_touch_cnt[MUTUAL5_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual5_in_touch[MUTUAL5_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual5_out_touch[MUTUAL5_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual5_touch_result[MUTUAL5_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual5_drift_permission[MUTUAL5_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual5_drift_ref[MUTUAL5_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual5_drift_cnt[MUTUAL5_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual5_key_uesd_info[MUTUAL5_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual5_sensor_index[MUTUAL5_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual5_counter_magni[MUTUAL5_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual5_tune_ctsuso[MUTUAL5_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual5_tune_result[MUTUAL5_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual5_calib[MUTUAL5_KEY_NUM][CALIB_TIME];   /* Mutual 5 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 6 )

#if ( MUTUAL_METHOD_NUM >= 7 )
/*****    Mutual 6 measurement data storage buffer    *****************************************************************/
TOUCH_EXTERN uint16_t    g_mutual6_ref[MUTUAL6_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual6_thr[MUTUAL6_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual6_user_thr[MUTUAL6_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual6_hys[MUTUAL6_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual6_delta[MUTUAL6_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual6_touch_cnt[MUTUAL6_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual6_non_touch_cnt[MUTUAL6_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual6_in_touch[MUTUAL6_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual6_out_touch[MUTUAL6_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual6_touch_result[MUTUAL6_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual6_drift_permission[MUTUAL6_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual6_drift_ref[MUTUAL6_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual6_drift_cnt[MUTUAL6_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual6_key_uesd_info[MUTUAL6_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual6_sensor_index[MUTUAL6_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual6_counter_magni[MUTUAL6_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual6_tune_ctsuso[MUTUAL6_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual6_tune_result[MUTUAL6_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual6_calib[MUTUAL6_KEY_NUM][CALIB_TIME];   /* Mutual 6 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 7 )

#if ( MUTUAL_METHOD_NUM >= 8 )
/*****    Mutual 7 measurement data storage buffer    ******************************************************************/
TOUCH_EXTERN uint16_t    g_mutual7_ref[MUTUAL7_KEY_NUM];                 /* Reference                                 */
TOUCH_EXTERN uint16_t    g_mutual7_thr[MUTUAL7_KEY_NUM];                 /* Threshold = Reference + User threshold    */
TOUCH_EXTERN uint16_t    g_mutual7_user_thr[MUTUAL7_KEY_NUM];            /* User threshold                            */
TOUCH_EXTERN uint16_t    g_mutual7_hys[MUTUAL7_KEY_NUM];                 /* Hysteresis                                */
TOUCH_EXTERN uint16_t    g_mutual7_delta[MUTUAL7_KEY_NUM];               /* Delta = Reference - Sensor counter        */
TOUCH_EXTERN uint16_t    g_mutual7_touch_cnt[MUTUAL7_KEY_NUM];           /* Touch count                               */
TOUCH_EXTERN uint16_t    g_mutual7_non_touch_cnt[MUTUAL7_KEY_NUM];       /* Non-touch count                           */
TOUCH_EXTERN uint16_t    g_mutual7_in_touch[MUTUAL7_MAX_GROUP];          /* Inside touch/non-touch data               */
TOUCH_EXTERN uint16_t    g_mutual7_out_touch[MUTUAL7_MAX_GROUP];         /* Outside touch/non-touch data              */
TOUCH_EXTERN uint16_t    g_mutual7_touch_result[MUTUAL7_MAX_GROUP];      /* Touch/non-touch result data               */
TOUCH_EXTERN uint16_t    g_mutual7_drift_permission[MUTUAL7_MAX_GROUP];  /* Drift permission                          */
TOUCH_EXTERN uint32_t    g_mutual7_drift_ref[MUTUAL7_KEY_NUM];           /* Drift addition reference                  */
TOUCH_EXTERN uint16_t    g_mutual7_drift_cnt[MUTUAL7_KEY_NUM];           /* Drift counter                             */
TOUCH_EXTERN uint16_t    g_mutual7_key_uesd_info[MUTUAL7_MAX_GROUP];     /* Used key infomation                       */
TOUCH_EXTERN uint8_t     g_mutual7_sensor_index[MUTUAL7_NUM];            /* Key sensor index                          */
TOUCH_EXTERN int8_t      g_mutual7_counter_magni[MUTUAL7_NUM];           /* Measurement time                          */
TOUCH_EXTERN uint16_t    g_mutual7_tune_ctsuso[MUTUAL7_NUM];             /* Offset tuning ctsuso data                 */
TOUCH_EXTERN  volatile   uint8_t    g_mutual7_tune_result[MUTUAL7_NUM];  /* Offset tuning result data                 */
TOUCH_EXTERN uint16_t    g_mutual7_calib[MUTUAL7_KEY_NUM][CALIB_TIME];   /* Mutual 7 measurement                      */
#endif    // ( MUTUAL_METHOD_NUM >= 8 )

#if (SLIDER_NUMBER == 0)
    TOUCH_EXTERN slider_info_t          g_sliderInfo[DUMMY_ID];
    TOUCH_EXTERN uint16_t               g_slider_data[DUMMY_ID];
    TOUCH_EXTERN uint16_t               g_slider_dsum[DUMMY_ID];
    TOUCH_EXTERN volatile uint16_t      g_slider_pos[DUMMY_ID];
#else
    TOUCH_EXTERN slider_info_t          g_sliderInfo[SLIDER_NUMBER];
    TOUCH_EXTERN uint16_t               g_slider_data[SLIDER_SENSOR_MAX];
    TOUCH_EXTERN uint16_t               g_slider_dsum[SLIDER_NUMBER];
    TOUCH_EXTERN volatile uint16_t      g_slider_pos[SLIDER_NUMBER];
    TOUCH_EXTERN index_info_t           g_slider_index[SLIDER_NUMBER];
#endif    // (SLIDER_NUMBER == 0)

#if (WHEEL_NUMBER == 0)
    TOUCH_EXTERN wheel_info_t           g_wheelInfo[DUMMY_ID];
    TOUCH_EXTERN uint16_t               g_wheel_data[DUMMY_ID];
    TOUCH_EXTERN uint16_t               g_wheel_dsum[DUMMY_ID];
    TOUCH_EXTERN volatile uint16_t      g_wheel_pos[DUMMY_ID];
#else
    TOUCH_EXTERN wheel_info_t           g_wheelInfo[WHEEL_NUMBER];
    TOUCH_EXTERN uint16_t               g_wheel_data[WHEEL_SENSOR_MAX];
    TOUCH_EXTERN uint16_t               g_wheel_dsum[WHEEL_NUMBER];
    TOUCH_EXTERN volatile uint16_t      g_wheel_pos[WHEEL_NUMBER];
    TOUCH_EXTERN index_info_t           g_wheel_index[WHEEL_NUMBER];
#endif    // (WHEEL_NUMBER == 0)
...
void     touch_moving_average_set( uint8_t method_num );
...
void     touch_judgement( uint8_t method, uint16_t key_val_sub, uint8_t group, uint8_t offset );
