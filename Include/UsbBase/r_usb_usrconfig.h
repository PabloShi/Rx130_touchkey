...
/* 1 = Use E1/E20 debug trace output for printf(). */
#define DEBUG_CONSOLE       0   /* 0 or 1 */
...
#ifdef  R8CUSB
  #define   USB_IP  (*(volatile struct st_usbip *)0x2E00)
#endif
#ifdef  RL78G1C
  #define   USB_IP  (*(volatile struct st_usbip *)0xF0400)
#endif
#ifdef  RL78L1C
  #define   USB_IP  (*(volatile struct st_usbip *)0xF0600)
#endif
#ifdef  __RX
